...
def main():
    ...
    def bayesian_optimization_function(x):
        dataset_path = 'dataset_640x480/Sekcje'
        ...
        learning_rate_multipliers = {'Conv1': current_conv1_multiplier, 'Conv2': current_conv2_multiplier,
                                     'Conv3': current_conv3_multiplier, 'Conv4': current_conv4_multiplier,
                                     'Dense1': current_dense1_multiplier}
        # l2-regularization penalization for each layer
        l2_penalization = {'Conv1': current_conv1_penalization, 'Conv2': current_conv2_penalization,
                           'Conv3': current_conv3_penalization, 'Conv4': current_conv4_penalization,
                           'Dense1': current_dense1_penalization}
        K.clear_session()
